...
<img width="1200" height="640" alt="project-banner" src="https://github.com/user-attachments/assets/3e054de2-212b-4933-8fa1-99f1a1997aa9" />
...
1 x Webcam, configured and working with VibeC64 (this will let the AI "see" the C64 Ultimate)<br>
...
<br>
Execute one of the two above scripts, on your local PC

```
./hello-world.py
# or
./i-love-my-commodore.py
```
<br>
...
<br>
And that’s it, you’re all done! You have configured your Pi Zero, installed the Network Daemon, configured the Serial Bridge and have VibeC64 connected to your Commodore C64 Ultimate, great work!<br>
<br><br>
